...
5. Summarize for the user in one or two lines: is CR wired, is it recording, and did the doctor repair anything just now. If both hooks are wired and stats are updating, say it's healthy. If the doctor repaired something, say what.
